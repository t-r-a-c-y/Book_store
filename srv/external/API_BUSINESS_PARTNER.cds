/* checksum : 2c2a9cbd142ee3653cc9ef4bf2c2590e */
@cds.external : true
...
service API_BUSINESS_PARTNER {
  ...
  entity A_BusinessPartnerRating {
    ...
    @sap.label : 'Long Text Rating'
    @sap.quickinfo : 'Long Text for Rating'
  ...
  entity A_Customer {
    ...
    @sap.display.format : 'UpperCase'
    @sap.label : 'CNAE'
    BR_EconomicActivityNatlClfn : String(7);
    @sap.display.format : 'NonNegative'
    @sap.label : 'Legal Nature'
    BR_BPLegalNatureType : String(4);
    @sap.display.format : 'UpperCase'
    @sap.label : 'CRT Number'
    BR_TaxRegimenCode : String(1);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Industry Main Type'
    BR_IndustryMainType : String(2);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Tax Declaration Type'
    BR_TaxDeclarationType : String(2);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Company Size'
    BR_BPCompanySizeType : String(2);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Decl. Reg. PIS/COFI'
    @sap.quickinfo : 'Declaration Regimen for PIS/COFINS'
    BR_PISAndCOFINSDeclnRegimen : String(2);
  ...
  entity A_Supplier {
    ...
    BR_TermsOfLiabilityAreAccepted : Boolean;
    @sap.label : 'Micro Company'
    @sap.quickinfo : 'Micro company indicator'
    BR_BPIsMicroCompany : Boolean;
    @sap.display.format : 'UpperCase'
    @sap.label : 'Company Size'
    BR_BPCompanySizeType : String(2);
    @sap.display.format : 'UpperCase'
